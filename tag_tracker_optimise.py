...
def pick_and_up(rob, gripper):
    ...
    rob.translate_tool((0.01,0,0.1), acc=0.1, vel=0.1, wait=True, threshold=None)#参考系是夹爪的坐标，系需要改底层
    
    time.sleep(1)
    gripper.move_percentage(50)
    time.sleep(1)
    rob.movel((0,0,0.3,0,0,0), acc=0.1, vel=0.1, relative=True)
